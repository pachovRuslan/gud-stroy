...
export default function ServicesPage() {
  return (
    <section className="px-8 py-12">
         <Container>
      <h1 className="text-3xl font-bold text-secondary mb-2">Услуги</h1>
      <p className="text-gray-600 mb-10">Строительство, фундаментные и земляные работы в Витебске и области</p>
